...
export default function PortfolioSummaryCard({ portfolio, onNewSearch, className }: PortfolioSummaryCardProps) {
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-start">
          ...
          {onNewSearch && (
            <button
              onClick={onNewSearch}
              className="px-4 py-2 text-sm font-medium text-secondary-foreground bg-secondary border border-border rounded-md hover:bg-secondary/80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-smooth"
            >
              New Search
            </button>
          )}
